...
export class AppComponent {
  ...
  productsData = [
    ...
    {
      image: "7.png",
      name: "Ассорти фирменного печенья<",
    ...
    {
      image: "11.png",
      name: "Веганское с шоколадной крошкой",
    ...
    {
      image: "12.png",
      name: "Крем-брюле ореховое печенье",
  ...
  scrollTo(target: HTMLElement, product?: any) {
    ...
    if (product) {
      this.form.patchValue({product: product.name + ' (' + product.price + ' ' + this.currency + ')'});
    }
  }
